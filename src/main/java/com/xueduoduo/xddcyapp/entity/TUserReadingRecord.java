 ...
 * @since 2019-05-06
 */
@TableName("t_user_reading_record")
public class TUserReadingRecord extends Model<TUserReadingRecord> {
	...
	public String toString() {
		return "TUserReadingRecord{" + "id=" + id + ", userName=" + userName + ", className=" + className + ", grade=" + grade + ", bookId=" + bookId
				+ ", catalogId=" + catalogId + ", createTime=" + createTime + ", year=" + year + ", month=" + month + ", dayOfMonth=" + dayOfMonth
				+ ", weekOfYear=" + weekOfYear + ", weekOfMonth=" + weekOfMonth + ", userId=" + userId + ", userCode=" + userCode + "}";
	}
